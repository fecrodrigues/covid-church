...
import br.com.fiap.api.security.JwtAuthenticationEntryPoint;
import br.com.fiap.api.security.JwtRequestFilter;
import br.com.fiap.api.security.JwtUserDetails;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(org.springframework.http.HttpMethod.POST,"/pessoa").permitAll()
